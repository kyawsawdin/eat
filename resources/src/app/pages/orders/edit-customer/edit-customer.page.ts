...
export class EditCustomerPage implements OnInit {
	...
	constructor(public service: Service, public values: Values, private route: ActivatedRoute, private router: Router, public navParams: NavParams, public modalCtrl: ModalController) {
