...
export class SelectVariationsPage implements OnInit {
    ...
    path: any = 'home';
  	constructor(public values: Values, private route: ActivatedRoute, private router: Router, public navParams: NavParams, public modalCtrl: ModalController, public navCtrl: NavController) { }
  	ngOnInit() {
